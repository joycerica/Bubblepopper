        ...
        <div class="Box container border border-secondary mt-5 p-0">
          ...
          <table class="table table-striped">
            ...
            while($row=mysqli_fetch_assoc($result)){
              ?>
              <tr><a href = "Edit.php" class="row-link">
                  <td name="code"><a href="Edit.php?code=<?php echo $row["CODE"];?>&teacher=<?php echo $user;?>"  class="row-link"><?php  echo $row["CODE"];?> </a></td>
                  <td name="gn"><a href="Edit.php?code=<?php echo $row["CODE"];?>&teacher=<?php echo $user;?>" class="row-link"><?php  echo $row["GAMENAME"];?></a></td>
                  <td name="sub"><a href="Edit.php?code=<?php echo $row["CODE"];?>&teacher=<?php echo $user;?>"  class="row-link"><?php  echo $row["SUBJ"];?> </a></td>
