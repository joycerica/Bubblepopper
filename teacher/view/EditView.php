 ...
 <!----NAVIGATION BAR END-->
          ...
          <table class="table">
            ...
            while($row=mysqli_fetch_assoc($result)){
              ?>
              <tr>
                  <td name="code"><a href="Edit.php?code=<?php echo $row["CODE"];?>" >
                  <?php  echo $row["CODE"];?> </td></a>
                  <td name="gn"><a href="Edit.php?code=<?php echo $row["CODE"];?>" >
                  <div style="height:150%;width:100%"><?php  echo $row["GAMENAME"];?></td></div></a>
                  <td name="sub"><a href="Edit.php?code=<?php echo $row["CODE"];?>" >
