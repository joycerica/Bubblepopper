...
?>
 <!----NAVIGATION BAR END-->
          ...
          <div class="blocks container">
            <div class="container">
              <div class="row">
                ...
                <input class="game" type="text" id="name" name='name'placeholder="Name required"></input>
                </div>
            ...
            <br>
            <label> ** Required to fill questions</label>
           <br>
          <div class="form-floating m-2">
          
            <textarea class="form-control" name="question1"onkeyup="success()" id="floatingTextarea12" style="height: 100px"></textarea>
          ...
          <!---RADIOT BUTTON ENDS-->
                    <!----CONTENT START------->
                    <div class="form-floating m-2">
            <textarea class="form-control" name="question2"onkeyup="success()" id="floatingTextarea22" style="height: 100px"></textarea>
          ...
          <!---RADIOT BUTTON ENDS-->
                    ...
                    <!----CONTENT START------->
                    <div class="form-floating m-2">
            <textarea class="form-control" name="question3"onkeyup="success()" id="floatingTextarea32" style="height: 100px"></textarea>
          ...
          <!---RADIOT BUTTON ENDS-->
                    ...
                    <!----CONTENT START------->
                    <div class="form-floating m-2">
            <textarea class="form-control" name="question4"onkeyup="success()" id="floatingTextarea52" style="height: 100px"></textarea>
          ...
          <!---RADIOT BUTTON ENDS-->
                    ...
                    <!----CONTENT START------->
                    <div class="form-floating m-2">
            <textarea class="form-control" name="question5"onkeyup="success()" id="floatingTextarea42" style="height: 100px"></textarea>
          ...
          <button type="submit" name="done" class="button" id="button" disabled>
            Done
...
<script type="text/javascript">
 function success() {
	 if(document.getElementById("floatingTextarea12").value=="" ||
            document.getElementById("floatingTextarea22").value=="" ||
            document.getElementById("floatingTextarea32").value=="" ||
            document.getElementById("floatingTextarea42").value=="" ||
            document.getElementById("floatingTextarea52").value=="" ||
...
<?php
         ...
         $_SESSION['coode'] = $mamama;
          ...
          VALUES('$Question1', '$A1','$B1','$C1','$D1', '$ans1')");
            ...
            $C2=$_POST['2C'];
            $D2=$_POST['2D'];
            $ans2=$_POST['flexRadioDefault2'];
            
          $result =mysqli_query($mysqli,"INSERT into quiz(Question,	A,	B,	C,	D, Answer)
          VALUES('$Question2', '$A2','$B2','$C2','$D2', '$ans2')");
          ...
          $Question3=$_POST['question3'];
            ...
            $C3=$_POST['3C'];
            $D3=$_POST['3D'];
            $ans3=$_POST['flexRadioDefault3'];
            
          $result =mysqli_query($mysqli,"INSERT into quiz(Question,	A,	B,	C,	D, Answer)
          VALUES('$Question3', '$A3','$B3','$C3','$D3', '$ans3')");
          ...
          $Question4=$_POST['question4'];
            ...
            $C4=$_POST['4C'];
            $D4=$_POST['4D'];
            $ans4=$_POST['flexRadioDefault4'];
            
          $result =mysqli_query($mysqli,"INSERT into quiz(Question,	A,	B,	C,	D, Answer)
          VALUES('$Question4', '$A4','$B4','$C4','$D4', '$ans4')");
